  ...
  },
  {
    ...
    routing: {
      send: {
        ...
        property: 'trigger',
        value:
          '={{ typeof $parameter.on_demand_trigger_input_object !== "undefined" ? JSON.parse($parameter.on_demand_trigger_input_object) : typeof $parameter.schedule_trigger_input_object !== "undefined" ? JSON.parse($parameter.schedule_trigger_input_object) : typeof $parameter.subscription_trigger_object !== "undefined" ? JSON.parse($parameter.subscription_trigger_object) : typeof $parameter.streaming_trigger_object !== "undefined" ? JSON.parse($parameter.streaming_trigger_object) : undefined }}',
      },
    },
    displayOptions: {
      show: {
