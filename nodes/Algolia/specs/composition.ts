...
const properties: INodeProperties[] = [
  ...
  },
  {
    ...
    "displayOptions": {
      "show": {
        "request_body_object": [
          'run_composition_parameters_as_object_object'
        ],
        "resource": [
          'Search'
        ],
  ...
  },
  {
    ...
    "displayOptions": {
      "show": {
        "composition_rule_object": [
          'composition_rule_consequence_object'
        ],
        "resource": [
          'Composition Rules'
        ],
  ...
  },
  {
    ...
    "displayOptions": {
      "show": {
        "composition_rules_batch_params_object": [
          'requests_json'
        ],
        "resource": [
          'Composition Rules'
  ...
  },
  {
    ...
    "displayOptions": {
      "show": {
        "search_composition_rules_params_object": [
          'query_string'
        ],
        "resource": [
          'Composition Rules'
