...
const properties: INodeProperties[] = [
          ...
          "output": {
            "postReceive": [
              ...
              return items.map((item) => {
                const json = item.json || {};
                const simplified = new Map();
                ["advancedSyntax","advancedSyntaxFeatures","allowCompressionOfIntegerArray","allowTyposOnNumericTokens","alternativesAsExact","attributeCriteriaComputedByMinProximity","attributeForDistinct","attributesForFaceting","attributesToHighlight","attributesToRetrieve"].forEach((f) => {
                  if (json[f] !== undefined) simplified.set(f, json[f]);
                });
                return { json: Object.fromEntries(simplified) };
              });
  ...
  },
  {
    ...
    "routing": {
      "send": {
        ...
        "value": '={{ typeof $parameter.aroundPrecision_number !== "undefined" ? $parameter.aroundPrecision_number : typeof $parameter.aroundPrecision_json !== "undefined" ? JSON.parse($parameter.aroundPrecision_json) : undefined }}'
      }
    },
    "displayOptions": {
      "show": {
  ...
  },
  {
    ...
    "displayOptions": {
      "show": {
        "index_settings": [
          'decompounded_attributes_object'
        ],
        "resource": [
          'Indices'
        ],
  ...
  },
  {
    ...
    "routing": {
      "request": {
        "qs": {
          "indexName": '={{ (() => { const value = typeof $parameter.indexName_string !== "undefined" ? $parameter.indexName_string : typeof $parameter.indexName_null !== "undefined" ? JSON.parse($parameter.indexName_null) : undefined; if (value !== undefined && value !== null) { return value; } return undefined; })() }}'
        }
      }
    },
    "displayOptions": {
