...
const properties: INodeProperties[] = [
  ...
  },
  {
    ...
    displayOptions: {
      show: {
        test_url_object: ['configuration_object'],
        resource: ['actions'],
        operation: ['testUrl'],
      },
    },
  ...
  },
  {
    ...
    routing: {
      send: {
        ...
        property: 'login',
        value:
          '={{ typeof $parameter.http_request_object !== "undefined" ? JSON.parse($parameter.http_request_object) : typeof $parameter.browserbased_object !== "undefined" ? JSON.parse($parameter.browserbased_object) : typeof $parameter.oauth_20_object !== "undefined" ? JSON.parse($parameter.oauth_20_object) : undefined }}',
      },
    },
    displayOptions: {
      show: {
  ...
  },
  {
    ...
    routing: {
      send: {
        ...
        value:
          '={{ typeof $parameter.renderJavaScript_boolean !== "undefined" ? $parameter.renderJavaScript_boolean : typeof $parameter.renderJavaScript_json !== "undefined" ? JSON.parse($parameter.renderJavaScript_json) : typeof $parameter.headless_browser_config_object !== "undefined" ? JSON.parse($parameter.headless_browser_config_object) : undefined }}',
      },
    },
    displayOptions: {
      show: {
