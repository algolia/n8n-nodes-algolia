...
const properties: INodeProperties[] = [
  ...
  },
  {
    ...
    "routing": {
      "send": {
        "type": 'body',
        "property": 'languages',
        "value": '={{ typeof $parameter.languages_json !== "undefined" ? JSON.parse($parameter.languages_json) : typeof $parameter.languages_boolean !== "undefined" ? $parameter.languages_boolean : undefined }}'
      }
    },
    "displayOptions": {
      "show": {
  ...
  },
  {
    ...
    "routing": {
      "send": {
        "type": 'body',
        "property": 'exclude',
        "value": '={{ typeof $parameter.exclude_json !== "undefined" ? JSON.parse($parameter.exclude_json) : typeof $parameter.exclude_null !== "undefined" ? JSON.parse($parameter.exclude_null) : undefined }}'
      }
    },
    "displayOptions": {
      "show": {
  ...
  },
  {
    ...
    "displayOptions": {
      "show": {
        "configuration_object": [
          'allowSpecialCharacters_boolean'
        ],
        "resource": [
          'configurations'
        ],
